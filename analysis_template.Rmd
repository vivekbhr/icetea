...
## ------------------  DEFINE VARIABLES -----------
seqfiles <- 	# prefix for the MAPCap sequencing reads file. Eg : "/path/to/seq_data/MAPCap_B"
...
makelinks <- function(x) {
	f1 <- paste0(x, "_R1.fastq.gz")
	f2 <- paste0(x, "_R2.fastq.gz")
