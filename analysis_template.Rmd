...
```{r functions,echo=FALSE,eval=FALSE,message=FALSE,warning=FALSE}
...
# map
mapIT <- function (x){
	mapcapR::mapCaps(index = "", # path to subread index /data/akhtar/bhardwaj/my_annotations/drosophila_dm6/subread_index/dm6
...
```{r filter,echo=FALSE,eval=FALSE,message=FALSE,warning=FALSE}
## Filter all BAMs
...
```{r peakcalling,echo=FALSE,eval=FALSE,message=FALSE,warning=FALSE}
...
```{r tsspres, echo=FALSE,eval=FALSE,message=FALSE,warning=FALSE }
gtf <- loadDb(GTFdb)
